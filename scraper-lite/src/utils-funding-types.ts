...
const FUNDING_TYPE_MAP: Record<string, string> = {
  ...
  // Invalid types that should be mapped or removed
  'services': null, // Not a funding type, remove
  'service': null, // Not a funding type, remove
  'coaching': null, // Not a funding type, remove
  'mentoring': null, // Not a funding type, remove
  'consultations': null, // Not a funding type, remove
  'consultation': null, // Not a funding type, remove
  'networking opportunities': null, // Not a funding type, remove
  'networking': null, // Not a funding type, remove
  'real estate': null, // Not a funding type, remove
  'real-estate': null, // Not a funding type, remove
  'funding': null, // Too generic, remove
  'unknown': null, // Remove unknown, try to infer from context
};
...
export function normalizeFundingTypes(types: string[] | null | undefined): string[] {
  ...
  for (const type of types) {
    ...
    if (mapped === null) {
      // Explicitly mapped to null = remove
      continue;
    } else if (mapped) {
