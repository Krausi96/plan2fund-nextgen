      ...
      <div className="prose max-w-none">
        ...
        <div className="mb-8 p-4 bg-gray-50 rounded-lg">
          <div className="flex flex-wrap gap-4">
            <a href="/privacy" className="text-blue-600 hover:text-blue-700 font-medium text-sm">
        ...
        <Card className="p-6 mb-6 bg-white shadow-sm border-neutral-200">
          ...
          <p className="text-sm text-gray-700">
            Your privacy is important to us. Please review our <a href="/privacy" className="text-blue-600 hover:underline">Privacy Policy</a> to understand our data practices.
          </p>
        </Card>
