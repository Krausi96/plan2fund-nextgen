...
// FULLY MIGRATED: All content from additionalDocuments.ts
...
// ============================================================================
// MASTER DOCUMENT TEMPLATES BY FUNDING TYPE AND PRODUCT
// ============================================================================
 ...
 */
export function getAdditionalDocuments(fundingType: string, productType: string): DocumentTemplate[] {
  ...
  if (MASTER_DOCUMENTS[funding] && MASTER_DOCUMENTS[funding][mappedProduct]) {
    return MASTER_DOCUMENTS[funding][mappedProduct];
  }
 ...
 */
export function getAdditionalDocument(fundingType: string, productType: string, documentId: string): DocumentTemplate | undefined {
 ...
 */
export function getRequiredDocuments(fundingType: string, productType: string): DocumentTemplate[] {
  const documents = getAdditionalDocuments(fundingType, productType);
 ...
 */
export function getDocumentsByFormat(fundingType: string, productType: string, format: string): DocumentTemplate[] {
  const documents = getAdditionalDocuments(fundingType, productType);
