...
// Simplified: Only product types (strategy/review/submission) - no funding type distinction
...
// ============================================================================
// STRATEGY SECTIONS (6 focused sections)
// ============================================================================
...
// ============================================================================
// FULL SECTIONS (for review/submission - same for all)
// ============================================================================
...
// ============================================================================
// EXPORT: Only product types, no funding type distinction
// ============================================================================
 ...
 * DEPRECATED: Funding type is ignored, returns by product type only
 */
export function getStandardSections(_fundingType: string): SectionTemplate[] {
  // Ignore funding type, return submission sections
  return MASTER_SECTIONS.submission;
}

/**
 * Get section by ID and funding type
 * DEPRECATED: Funding type is ignored
 */
