          ...
          <div className="absolute left-0 top-[80px] z-[100] border border-white/20 bg-slate-950/95 backdrop-blur-xl rounded-lg p-2.5 space-y-2 min-w-[420px] max-w-[420px] shadow-2xl">
            ...
            <div className="flex gap-2 pt-1">
              ...
              <Button
                onClick={onToggleAddDocument}
                variant="ghost"
                className="border-2 border-red-400/60 bg-red-500/20 text-white hover:bg-red-500/30 hover:border-red-400/80 hover:text-white text-xs px-4 py-1.5 font-semibold shadow-md"
              >
