...
// FULLY MIGRATED: All content from standardSectionTemplates.ts
...
// ============================================================================
// MASTER SECTION TEMPLATES BY FUNDING TYPE
// ============================================================================
...
export function getStandardSections(fundingType: string): SectionTemplate[] {
  ...
  switch (type) {
    ...
    case 'bank_loans':
    case 'loan':
      return MASTER_SECTIONS.bankLoans;
    case 'equity':
    case 'investment':
      return MASTER_SECTIONS.equity;
    case 'visa':
    case 'residency':
      return MASTER_SECTIONS.visa;
    default:
      return MASTER_SECTIONS.grants; // Default to grants
  }
}
