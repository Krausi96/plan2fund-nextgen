...
import { type Product } from '@/shared/types/plan';
import { type FundingType } from '@/shared/data/basisPack';
import { type TargetGroup } from '@/features/intake/engine/targetGroupDetection';
